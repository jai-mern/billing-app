...
const Dashboard = () => {
  ...
  const handleEdit = (index) => {
    ...
    setSelectedDate(new Date(userDetails.selectedDate)); // Convert to Date object
    ...
    <div className="container mt-5">
      <div className="card">
        ...
        <div className="card-body">
          <h1>Welcome to inventory billing app </h1>

          <div className="charts-container">
            {/* Add your charts or visualizations here */}
            <p style={{ color: 'orange' }}>User Details</p>

            <p>name date mobileno address location</p>
          </div>
          ...
          <h3 style={{ color: 'green' }}>Enter User Details</h3>
